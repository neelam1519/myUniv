...
class _AcademicDetailsState extends State<AcademicDetails> {
  ...
  void initState() {
    super.initState();
    final provider = Provider.of<AcademicDetailsProvider>(context, listen: false);
    provider.init();
  }

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<AcademicDetailsProvider>(context);
          ...
          child: Column(
            children: <Widget>[
              DropdownButtonFormField<String>(
                ...
                onChanged: (newValue) {
                    provider.selectedYear = newValue;
                    provider.selectedBranch = null;
                    provider.selectedSpecialization = null;
                    provider.selectedSection = null;
                    provider.branches = [];
                    provider.specializations = [];
                    provider.sections = [];
                    provider.fetchBranches(newValue!);
                },
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please select a year';
              ...
              DropdownButtonFormField<String>(
                ...
                items: provider.branches.map((String branch) {
                  return DropdownMenuItem<String>(
                    value: branch,
                    child: Text(branch),
                  );
                ...
                onChanged: (newValue) {
                    provider.selectedBranch = newValue;
                    provider.selectedSpecialization = null;
                    provider.selectedSection = null;
                    provider.specializations = [];
                    provider.sections = [];
                    provider.fetchSpecializations(provider.selectedYear!, newValue!);
                },
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please select a branch';
              ...
              DropdownButtonFormField<String>(
                ...
                items: provider.specializations.map((String specialization) {
                  return DropdownMenuItem<String>(
                    value: specialization,
                    child: Text(specialization),
                  );
                ...
                onChanged: (newValue) {
                    provider.selectedSpecialization = newValue;
                    provider.selectedSection = null;
                    provider.sections = [];
                    provider.fetchSections(provider.selectedYear!, provider.selectedBranch!, newValue!);
                },
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please select a specialization';
              ...
              DropdownButtonFormField<String>(
                ...
                items: provider.sections.map((String section) {
                  return DropdownMenuItem<String>(
                    value: section,
                    child: Text(section),
                  );
                ...
                onChanged: (newValue) {
                    provider.selectedSection = newValue;
                },
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please select a section';
